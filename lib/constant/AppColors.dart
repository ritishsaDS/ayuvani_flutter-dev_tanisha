...
// const appColorPrimary = Color(0xffff607a);
const appColorPrimary = Color(0xff75afaa);
const appColorPrimaryDark = Color(0xffff607a);
...
const lightblueColor = Color(0xFF87CEFA);
// Dark Theme Colors
...
// const apptextcolor = Color(0xffff607a);
const apptextcolor = Color(0xff75afaa);

// colors for service wise screens
const ayurvadicGreen = Color(0xFF098251);
const yogaBlue = Color(0xFF25a4af);
const unaniPurple = Color(0xFFb65cd3);
const siddhaOrange = Color(0xFFe3853a);
const sowaPink = Color(0xFFed5c96);
const homeopathyPeach = Color(0xFFeb4e61);
