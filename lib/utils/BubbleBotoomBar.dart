...
import 'package:flutter_ayuvani/main.dart';
...
BubbleBottomBarItem tab(IconData iconData, String tabName) {
  return BubbleBottomBarItem(
      ...
      icon: Icon(iconData, color: appStore.iconColor),
      activeIcon: Container(
        child: Icon(iconData, color: white),
        margin: EdgeInsets.only(left: SizeConfig.blockSizeHorizontal*0.3),
      ),
      title: Container(
        margin: EdgeInsets.only(right: SizeConfig.blockSizeHorizontal*0.3),
        child: Text(
          tabName,
          style:
              primaryTextStyle(size: (SizeConfig.blockSizeVertical*1.5).toInt(), weight: FontWeight.w600, color: white),
          maxLines: 2,
        ),
      ));
}
